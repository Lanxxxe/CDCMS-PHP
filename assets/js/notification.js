                    ...
                    data.notifications.forEach(n => {
                        let notificationHTML = `
                            <div class="alert alert-primary alert-dismissible fade show d-flex align-items-center justify-content-start" role="alert" id="notification">
                                ${n.file_path ? `<img class="fade show" src="../enrollment_process/${n.file_path}" width="35" height="35">` : `<img class="fade show" src="/images/default-notif.png" width="35" height="35">`}
