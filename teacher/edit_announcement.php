...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Handle file upload
        $picture = $announcement['picture']; // Keep existing picture by default
        ...
        if (isset($_FILES['picture']) && $_FILES['picture']['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($fileTmp, $destination)) {
                ...
                if (!empty($announcement['picture'])) {
                    $oldPicturePath = $uploadDir . $announcement['picture'];
                        ...
                        <div class="card-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="5" required><?php echo htmlspecialchars($announcement['description']); ?></textarea>
                                </div>
