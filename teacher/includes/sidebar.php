<aside class="sidebar-left border-right bg-white " id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar-side navbar-light">
        ...
        <ul id="guardian_management" class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item w-100">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2" id="announcement">
            <li class="nav-item w-100">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2" id="attendance">
            <li class="nav-item w-100">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2" id="grades">
            <li class="nav-item w-100">
